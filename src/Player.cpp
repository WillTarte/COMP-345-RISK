...
int Player::attack() {
    ...
    static char playerChoice = 0;
    static int fromCountryIndex = -1;
    static int toCountryIndex = -1;
    static int numAttackingDice = -1;
    static int numDefendingDice = -1;
    ...
    do {
        std::cout << "Country " << fromCountry->getCountryName() << " has " << fromCountry->pAdjCountries->size()
                  << " neighbours\n";
